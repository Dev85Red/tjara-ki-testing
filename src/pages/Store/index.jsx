      ...
      {customerServicePopup && (
        <div className="customerServicePopup">
          ...
          <div className="container">
            ...
            <div className="icons">
              {(() => {
                const phone = Store?.meta?.phone;
                const phoneAreaCode = Store?.meta?.area_code ?? '';
              ...
              {(() => {
                const whatsapp = Store?.meta?.whatsapp;
                const whatsappAreaCode = Store?.meta?.whatsapp_area_code ?? '';
