...
function AllCategories() {
  ...
  const { sethomeSubCategoriesId, homeSubCategoriesId, sethomeSubCategoriesTitle } = usePopup();
      ...
      >
        <div className="all-category-item-img-box">
          {categoryItem?.thumbnail ? (
            <ImageWithFallback url={getOptimizedThumbnailUrl(categoryItem?.thumbnail)} name={categoryItem?.name} />
          ) : (
        ...
        <Swiper {...swiperProps}>
          <SwiperSlide>
            <div
              ...
              <div className="all-category-item-img-box">
                <img src={globalSettings?.all_categories_image_url ?? AllCategoriesIcon} alt="" />
              </div>
              <p> All Categories</p>
            </div>
          </SwiperSlide>
