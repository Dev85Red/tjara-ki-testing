...
export const setChunkedCookies = (key, data, chunkSize = 3000) => {
  ...
  for (let i = 0; i < numChunks; i++) {
    ...
    Cookies.set(`${key}_chunk_${i}`, chunk, { domain: '.tjara.com', path: '/', secure: true, sameSite: 'strict' });
  }
  Cookies.set(`${key}_chunk_count`, numChunks, { domain: '.tjara.com', path: '/', secure: true, sameSite: 'strict' });
};
...
export const removeChunkedCookies = (key) => {
  ...
  const cookieOptions = { domain: '.tjara.com', path: '/', secure: true, sameSite: 'strict' };
